...
const menuItems = [
  ...
  { name: "Portal Update", href: "/system-info", icon: Info },
  { name: "Invoicing", href: "/insurance", icon: Shield },
  { name: "Benificiary Share", href: "/jcc-completion", icon: CheckCircle2 },
  { name: "JCR Status", href: "/jcc-status", icon: Activity },
  { name: "System Info", href: "/beneficiary-share", icon: Users },
