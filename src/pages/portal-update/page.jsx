...
export default function PortalUpdatePage() {
    ...
    const handlePhotoUpload = (e, index) => {
        ...
        const files = [...formData.photo_links];
    ...
    const addPhotoField = () => {
        if (formData.photo_links.length >= 6) return;
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            for (const file of formData.photo_links) {
                                ...
                                <div className="grid gap-6 p-5 sm:p-6 bg-slate-50/30">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                        ...
                                        <div className="space-y-2 col-span-2">
                                            ...
                                            {formData.photo_links.map((photo, index) => (
